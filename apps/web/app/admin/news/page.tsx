...
export default async function NewsListPage({ searchParams }: { searchParams?: Promise<{ role?: string }> }) {
  ...
  return <NewsConsole identity={identity} initialSnapshot={newsRepository.snapshot(newsActor(identity))} />;
}
